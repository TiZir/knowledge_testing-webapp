...
<html lang="en, ru">
    <head>
        ...
        <header  class="Menu">
            <nav class="dws-menu">
                <div>
                    <a class="Main" href="teachermain.php">
                        <span>Главная</span>
                    </a>

                    <a class="Other" href="testcreation.php">
                        <span>Тестирование</span>
                    </a>
                    
                    <a class="Other" href="resultcheck.php">
                    ...
                    <div class="Profile dropdown">
                        ...
                        <div class="dropdown-content">
                            <br>
                            <a href="/TestingSystem/verification.php">Проверка</a>
                            <a href="/TestingSystem/exit.php">Выход</a>
                        </div>
                    </div>
                </div>
            </nav>
